...
$og_image        = $og_image        ?? ($siteBase . '/cdn/og-default.jpg');
...
<head>
    ...
    <link rel="stylesheet" href="<?= $siteBase ?>/assets/css/admin.css?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'] . '/assets/css/admin.css') ?: time() ?>">
