...
$page_description = $isEn
    ? 'FEZADAN Manifesto — a declaration on the silent conflict between data and aesthetics.'
    : 'FEZADAN manifestosu — veri ve estetik arasındaki sessiz çatışma üzerine bir bildirge.';
