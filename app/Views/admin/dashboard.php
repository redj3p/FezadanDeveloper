                            ...
                            <tr class="border-b border-[var(--text-main)]/10 hover:bg-[var(--bg-secondary)]/20 transition-colors h-20">
                                ...
                                <td class="p-4 text-center">
                                    <div class="flex justify-center gap-2 flex-col md:flex-row items-center">
                                        ...
                                        <?php if(($article['status'] ?? 'published') === 'draft'): ?>
                                        <form method="POST" action="/admin/publish?id=<?php echo $article['id']; ?>" onsubmit="return confirm('Makaleyi yayınlamak istiyor musun?');" class="contents">
                                            <?= Csrf::field() ?>
                                        ...
                                        <?php endif; ?>
                                        <form method="POST" action="/admin/delete?id=<?php echo $article['id']; ?>" onsubmit="return confirm('Silmek istediğine emin misin?');" class="contents">
                                            <?= Csrf::field() ?>
                        ...
                        <div class="mb-6 last:mb-0 relative pl-6 border-l-2 <?php echo $index === 0 ? 'border-[var(--text-accent)]' : 'border-[var(--text-main)]/30'; ?>">
                            ...
                            <div class="flex justify-between items-start mb-1">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form method="POST" action="/admin/patch-delete?id=<?php echo $patch['id']; ?>" onsubmit="return confirm('Bu yama notunu silmek istediğinize emin misiniz?');" class="inline">
                                        <?= Csrf::field() ?>
